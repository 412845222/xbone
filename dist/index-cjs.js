...
class Xbone {
  ...
  gridDataRelative(index, griding_info = null) {
    ...
    reload_point = new Victor__default["default"](
    ...
    let relative_img_point_move = new Victor__default["default"](
    ...
    gridingPoint.forEach((point) => {
      let temp_point = new Victor__default["default"](
  ...
  getParentBoneRotatePoint(point, boneList, b_idx, img_point, angleList) {
    ...
    for (let i = 1; i <= b_idx; i++) {
      let bone = boneList[i];
      bone = [
        new Victor__default["default"](bone[0].x, bone[0].y),
        new Victor__default["default"](bone[1].x, bone[1].y),
        new Victor__default["default"](bone[2].x, bone[2].y),
      ];
      ...
      new_point = new Victor__default["default"](new_point.x, new_point.y);
      img_point = new Victor__default["default"](img_point.x, img_point.y);
      retrun_point = new_point;
    }
    return retrun_point
  }
  replaceRotatePoint(angle, bone, point, img_point) {
    let orgP = new Victor__default["default"](bone[1].x, bone[1].y);
    let newP = new Victor__default["default"](point.x, point.y);
  ...
  getTransformMatrix(old_t, new_t) {
    let matrixFrom = null;
    let matrixTo = null;
    let matrixTransform = new three.Matrix3();
    let itemList = null;

    matrixFrom = new three.Matrix3();
    matrixFrom.set(
      old_t[0].x,
      old_t[0].y,
      1,
  ...
  setBoneMoved_angle(info, index, boneIndex, angle) {
    ...
    initBone = [
      new Victor__default["default"](initBone[0].x, initBone[0].y),
      new Victor__default["default"](initBone[1].x, initBone[1].y),
      new Victor__default["default"](initBone[2].x, initBone[2].y),
    ];
    let img_point = info.img_point;
    ...
    rotateBone = [
      new Victor__default["default"](rotateBone[0].x, rotateBone[0].y),
      new Victor__default["default"](rotateBone[1].x, rotateBone[1].y),
      new Victor__default["default"](rotateBone[2].x, rotateBone[2].y),
    ];
    if (boneIndex > 0) {
      let pre_bone = boneList[boneIndex - 1];
      pre_bone = [
        new Victor__default["default"](pre_bone[0].x, pre_bone[0].y),
        new Victor__default["default"](pre_bone[1].x, pre_bone[1].y),
        new Victor__default["default"](pre_bone[2].x, pre_bone[2].y),
      ];
  ...
  subBoneLinkAge(info, boneIndex) {
    ...
    boneList.forEach((bone, b_idx) => {
      if (b_idx > boneIndex) {
        ...
        bone[1] = new Victor__default["default"](new_point_1.x, new_point_1.y);
        ...
        bone[0] = new Victor__default["default"](new_point_0.x, new_point_0.y);
